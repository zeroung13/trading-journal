...
function transform(page, source) {
  ...
  return {
    ...
    smtStage:    prop(page, 'SMT Stage'),
    smtType:     prop(page, 'SMT Type'),
    universalModel: prop(page, 'Universal Model'),
    candleProfiling: prop(page, 'Candle Profiling'),
    condition:   prop(page, 'Condition'),
